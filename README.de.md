...
`tidyfactor-skill-architect` ist das zentrale Governance- und Qualitätskontroll-Framework zur Prüfung und Standardisierung von KI-Agenten-Fähigkeiten nach 13 strukturellen Kernregeln.

---

## Kernbefehle

- `/init`: Initialisierung neuer normkonformer Skills.
- `/audit`: 13-Regeln-Strukturaudit und Qualitätsprüfung.
- `/grow`: Trigger-basierte Funktionserweiterung.
- `/test`: Deterministische Testläufe und Verhaltensprüfung.
